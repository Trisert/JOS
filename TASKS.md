...
| 32 | done | **Subagent reviews (criterio 3)**: #70 APPROVE, #63 REQUEST-CHANGES (CSELR, pin-mapping, DMA morto), #72 APPROVE, #68 APPROVE, #69 REQUEST-CHANGES→fixato `cr=8` (`af29496`). | — | #63: da rilavorare, non mergiare. |
| 33 | doing | **FRAM full-size 128KB/chip (512KB)** → PR #73 `fix/fram-size`: A16 in slave byte, decode chip=addr>>17, fakes+2 test, build ok, 146/146. | [#73](https://github.com/Trisert/JOS/pull/73) | Review subagent in corso. Flag: confermare strapping A2/A1 con Nicola. |
