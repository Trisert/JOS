...
| 33 | doing | **FRAM full-size 128KB/chip (512KB)** → PR #73: rework `414ae83` (split cross-chip, fram_range_valid 64-bit, commenti). Build ok, 147/147. | [#73](https://github.com/Trisert/JOS/pull/73) | Re-review in corso. Resta: strapping A2/A1 (Nicola). |
