...
| 30 | done | **FRAM→SPI2+DMA (SPF §3.6.4.2)** → PR #71 `fix/fram-spi2`: memory.c su SPI2, CS definiti, DMA Ch4/5, `make release` ok, 144/144. | [#71](https://github.com/Trisert/JOS/pull/71) | CI VERDE. Flag: PA4 conteso tra FRAM CS e radio CS_TTC TODO — decisione Nicola. |
...
| 32 | done | **Subagent reviews (criterio 3)**: #70 APPROVE, #71 REQUEST-CHANGES (PA4 + CSELR→fixato `4431be0`), #63 REQUEST-CHANGES (CSELR, pin-mapping, DMA morto), #72 APPROVE, #68 APPROVE. | — | #71: resta blocker PA4 (Nicola). #63: da rilavorare, non mergiare. |
