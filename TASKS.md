...
| 28 | doing | **Fix LoRa CR 4/9→4/8 (SPF Tab. 3.28)** — subagent: worktree `/root/JOS-lora-cr`, branch `fix/lora-cr-4-8`, `cr=5`→`4` in `radiolib_driver.cpp:60`, `make release` exit 0. | [#69](https://github.com/Trisert/JOS/pull/69) | PR aperta, CI in corso. Non mergiata (attende via). |
