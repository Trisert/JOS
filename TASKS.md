...
| 16 | todo | **T33 — DMA SPI1 (SPF §3.6.4.2)**: configurare DMA per SPI1 (SX1268) con DMA1_Channel2/Channel3 + DMAMUX request 11/12. In worktree `feat/dma-spi1-sx1268`. Compilato, PR da creare. | — | [Worktree:](file:///root/JOS-t33a-dma-spi1) `feat/dma-spi1-sx1268`. DMA configurato, polling attivo (documentato). PR da creare: `make release` green, 67 KB. |
...
| 18 | blocked | **T35 — Timebase TIM6 (SPF §3.6.4) + anomaly detection task (SPF §3.6.1)**: migrare da SysTick a TIM6 per FreeRTOS tick; aggiungere task anomaly detection dedicato se watchdog attuale non copre. | — | Subagent T35 ha completato la verifica (da leggere). Migrazione TIM6 complessa (impatta SysTick-dependent code). Raccomandazione: documentare scelta. |
...
*Ultimo aggiornamento: 2026-09-08 — task 16 (T33 DMA SPI1) compilato, PR da creare; task 17-19 blocked; task 20 todo.*
