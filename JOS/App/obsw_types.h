...
enum {
    ...
    /* Dual-bank golden-image fallback bookkeeping (Core/Src/dual_bank.c).
       ...
       Numbered after the fault/CRC/MPU/SRAM2 triggers already merged on main
       (#9/#10/#13/#14); the wire values are part of the ground telemetry
       contract, so existing codes are never renumbered. */
    TRIGGER_BOOT_FAULT      = 13,  /* HardFault/NMI during early boot */
    TRIGGER_BOOT_OK         = 14,  /* boot reached the scheduler      */
};
