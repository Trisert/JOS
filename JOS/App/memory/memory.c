 ...
 * cross-chip transfer: each FM24VN10-G owns only its 128 KB window, and a
 * transfer past it would address a different slave. (The A16 page boundary
 * inside a chip needs no split: the part streams across it.) */
